---
name: cre-deal-intake
description: Use when converting a raw CRE opportunity into structured deal state and an OpenClaw workpad.
license: Apache-2.0
---
...
Use when converting a raw CRE opportunity into structured deal state and an OpenClaw workpad.
