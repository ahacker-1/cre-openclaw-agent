# CRE Acquisition TaskFlow

## Purpose

Coordinate cre acquisition taskflow work inside OpenClaw using durable state, visible workpads, explicit missing data, and approval gates.
...
```text
created -> triaged -> active -> waiting_on_input -> approval_needed -> completed
```
