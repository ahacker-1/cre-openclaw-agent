...
Coordinate cre ic memo work inside OpenClaw using durable state, visible workpads, explicit missing data, and approval gates.
...
```text
requested -> outline_created -> sections_drafted -> gaps_marked -> review_ready -> approved_for_external_use
```
