...
Coordinate cre underwriting review work inside OpenClaw using durable state, visible workpads, explicit missing data, and approval gates.
...
```text
queued -> data_checked -> assumptions_reviewed -> risks_logged -> recommendation_drafted -> ready_for_approval
```
