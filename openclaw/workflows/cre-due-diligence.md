...
Coordinate cre due diligence work inside OpenClaw using durable state, visible workpads, explicit missing data, and approval gates.
...
```text
opened -> checklist_created -> evidence_requested -> evidence_reviewed -> issues_logged -> diligence_summary_ready
```
